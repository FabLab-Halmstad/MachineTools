...
description="Setup-sheet-multi";
vendor = "FabLabWS";
vendorUrl = "hh.se";
certificationLevel = 2;

longDescription = "FabLab WS Setup-sheet - Multi";
...
setCodePage("utf-8");
dependencies = "setup-sheet-WSMulti-style.css";
...
var logoLen=26; //Length of logo on first page
var topTableLen=24; //Top table length
var setupInfoLen=75; //Setup info length
var tableHeadLen=20; //Table header length
...
function htmlSetup()
{
    ...
    "<style type=\"text/css\"> \n" +
    loadText("setup-sheet-WSMulti-style.css","utf-8") + "\n" +
    "</style> \n" +
...
function onOpen() //On init of post
{
    ...
    if(getProperty("writeTools")) contentLength+=tableHeadLen;
    if(getProperty("writePaths")) contentLength+=tableHeadLen;
